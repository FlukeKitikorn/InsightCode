    ...
    return (
        <PageLayout currentPage="workspace" onNavigate={onNavigate} fullScreen>
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <div className="flex-1 flex flex-col bg-[#fafafa] dark:bg-[#0b0e14] min-w-0">
                    {/* Editor Toolbar */}
                    ...
                    <div className="flex-1 bg-[#1e1e1e] text-[#d4d4d4] font-mono text-sm overflow-hidden relative">
                        <div className="absolute inset-0 flex">
                            {/* Line Numbers */}
                            <div className="w-12 bg-[#1e1e1e] text-[#858585] text-right pr-4 py-4 select-none border-r border-[#333] text-xs leading-relaxed shrink-0">
                                {DEFAULT_CODE.split('\n').map((_, i) => (
                                    <div key={i}>{i + 1}</div>
                                ))}
                            </div>
                            {/* Highlighted Code */}
                            <div className="flex-1 p-4 overflow-auto leading-relaxed">
                                <pre className="whitespace-pre text-xs md:text-sm">
                                    ...
                                    <span className="text-[#4ec9b0]">List</span>[<span className="text-[#4ec9b0]">int</span>],{' '}
                                    <span className="text-[#9cdcfe]">target</span>:{' '}
                                    <span className="text-[#4ec9b0]">int</span>) -&gt;{' '}
                                    <span className="text-[#4ec9b0]">List</span>[<span className="text-[#4ec9b0]">int</span>]:{'\n'}
                                    {'        '}<span className="text-[#6a9955]"># Optimized with Hash Map</span>{'\n'}
                                    {'        '}<span className="text-[#9cdcfe]">prevMap</span> = {'{}'}{'  '}<span className="text-[#6a9955]"># val : index</span>{'\n'}
                                    ...
                                    <span className="text-[#dcdcaa]">enumerate</span>(<span className="text-[#9cdcfe]">nums</span>):{'\n'}
                                    ...
                                    <span className="text-[#9cdcfe]">diff</span>{' '}
                                    <span className="text-[#c586c0]">in</span>{' '}
                                    <span className="text-[#9cdcfe]">prevMap</span>:{'\n'}
                                    {'                '}<span className="text-[#c586c0]">return</span> [<span className="text-[#9cdcfe]">prevMap</span>[<span className="text-[#9cdcfe]">diff</span>],{' '}
                                    <span className="text-[#9cdcfe]">i</span>]{'\n'}
                                    {'            '}<span className="text-[#9cdcfe]">prevMap</span>[<span className="text-[#9cdcfe]">n</span>] ={' '}
                                    <span className="text-[#9cdcfe]">i</span>{'\n'}
                ...
                <aside className="w-72 xl:w-80 border-l border-[#e8ebf3] dark:border-[#2d3748] bg-blue-50 dark:bg-[#1a202c] hidden lg:flex lg:flex-col shrink-0">
                    <div className="p-4 border-b border-[#d1d9e6] dark:border-[#2d3748] flex items-center gap-2">
                    ...
                    {/* AI Ask Button */}
                    <div className="p-4 bg-white/50 dark:bg-black/20 border-t border-[#d1d9e6] dark:border-gray-800">
                        <button className="w-full py-2 bg-white dark:bg-gray-800 border border-[#5586e7]/30 text-[#5586e7] text-xs font-bold rounded-lg hover:bg-[#5586e7]/5 transition-colors">
                            Ask AI Assistant
                        </button>
                    </div>
                </aside>
            ...
            {/* ── Status Bar (bottom of workspace) ─────────────────── */}
            <footer className="bg-white dark:bg-[#111621] border-t border-[#e8ebf3] dark:border-[#2d3748] px-4 py-1.5 flex items-center justify-between text-[11px] text-gray-500 shrink-0">
